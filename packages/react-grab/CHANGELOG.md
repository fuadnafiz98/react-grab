...
- Start the independent fork release line. This release restores persistent comment history with per-item actions, session reload support, and Copy all.

### Patch Changes

- Include the upstream hit-testing and viewport performance improvements present when the fork release line was established.
...
- 1c5343a: Restore persistent comment history with per-item actions, session reload support, and Copy all.
